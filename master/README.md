...
**hr@velocube.net** and controls everything: every Supabase auth account
...
- adds hr@velocube.net to `agents` (grants full data access through RLS)
...
Open `velocube.net/master/`, sign in as hr@velocube.net, go to
**Settings → Check control link**. It should answer
`OK — v1 answering as hr@velocube.net`.
